...
try:
    ...
    browser.execute_script("document.getElementsByTagName('button')[0].classList.remove('trollface');") # это скрипт для удаления класса, с помощью которого кнопка перемещается
    button_1.click()
