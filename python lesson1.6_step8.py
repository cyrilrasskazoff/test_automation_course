...
# по полному совпадению текста. //p[text()="Lenin cat"]. Такой селектор вернет элемент, только если текст полностью совпадет.
# по частичному совпадению текста или атрибута. //p[contains(text(), "cat")] вернет нам все абзацы текста, которые содержат слово cat
